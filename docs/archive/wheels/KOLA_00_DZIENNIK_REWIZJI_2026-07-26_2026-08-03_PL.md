> **ARCHIWUM — nie jest bieżącą instrukcją.** Zachowuje chronologiczny dziennik programu kół. Aktualny start: [`docs/JV_DOCS_INDEX_PL.md`](../../JV_DOCS_INDEX_PL.md).

# KOLA_00 — historyczny dziennik rewizji

Zakres: 2026-07-26–2026-08-03. Bloki przeniesiono bez zmiany ich treści z dawnego `KOLA_00_INDEX_PL.md`, aby front door nie wymagał czytania całej historii przed rozpoczęciem pracy.
