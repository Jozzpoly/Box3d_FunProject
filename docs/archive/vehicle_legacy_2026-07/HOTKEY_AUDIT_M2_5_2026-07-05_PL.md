> **ARCHIWUM — nie jest bieżącą instrukcją.** Zachowuje audyt skrótów z epoki M2.5. Aktualny start: [`docs/JV_DOCS_INDEX_PL.md`](../../JV_DOCS_INDEX_PL.md).

# Hotkey Audit — Jozz Vehicle Box3D Native

Date: 2026-07-05
Branch/snapshot: patrz `CURRENT_STATE_INDEX_PL.md`
