> **ARCHIWUM — snapshot 2026-07.** Ten plik zachowuje dawny stan podsystemu i nie jest bieżącą instrukcją. Aktualny kontrakt: `../../SUBSYSTEM_RIG_DAMPER_MOUNT_PL.md`.
...
Pełna historia decyzji: `archive/vehicle_legacy_2026-07/M8_SUSPENSION_RIG_REPAIR_PLAN_PL.md` §6f/§8–11.
...
|---|---|---|
| **Sprężyna fizyczna (wishbone)** | hardpointy: `jozz_vehicle_m6_geometry.cpp` (`MakeWishboneHardpoints`, po R5); joint: `jozz_vehicle_m6_suspension_rig.cpp` (`CreateWishboneCorner`) | `b3DistanceJoint` coilover: `coiloverChassis` (chassis) → `coiloverKnuckle` = **dolny ball-joint**. To ona trzyma masę. |
