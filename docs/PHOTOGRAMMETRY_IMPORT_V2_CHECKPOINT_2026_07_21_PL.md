...
- bieżący branch pochodzi od `Photogrametry_Import_experiment` przy bazowym commicie `f1c4919e501721749084210aea9b571e96b69bed`;
...
3. kopiuje validator baseline;
4. kopiuje quad screenshot M6;
5. mierzy czas gate;
...
`build/` jest już ignorowany przez Git.
...
Testy pokrywają SHA-256, izolację ścieżki raw skanu, ochronę prywatności raportu, wybór końcowej linii gate oraz blokadę kopiowania starych artefaktów baseline.
...
Każdy błąd kończy się kodem różnym od zera i pozostawia P1 zablokowane.
...
Nie rozpoczęto P1. To celowe zastosowanie kryterium STOP, a nie brak implementacji.
